...
// UnmarshalJSON accepts either a JSON object or a bare JSON string.
func (n *namespaceRef) UnmarshalJSON(data []byte) error {
	...
	if data[0] == '"' {
		...
		n.namespace = &namespace{Path: s, Name: s}
		return nil
	}
	var ns namespace
